...
class RangeControllerHandler implements IControllerHandler {
    ...
    // Вызывается при перемещении бегунка. Записывает данную позицию в Модель и перемещает бегунок на позицию.
    ...
    public updateTipsPositionAndText() {
